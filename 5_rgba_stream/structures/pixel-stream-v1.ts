...
export class PixelStreamV1 extends PixelStreamBase<number[]> implements PixelStream {
    ...
    protected validateSize(pixels: number[], width: number, height: number): void {
    ...
    protected validateFormat(pixels: number[]): void {
